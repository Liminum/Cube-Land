...
void ParticleSystem::Update(sf::Time _elapsedTime)
{
    for (std::size_t i = 0; i < m_Particles.size(); ++i)
    {
        // update the particle lifetime
...
void ParticleSystem::SetColor(sf::Color _color)
{
    for (std::size_t i = 0; i < m_Particles.size(); ++i)
    {
...
void ParticleSystem::ResetParticle(std::size_t _index)
{
...
void ParticleSystem::KillParticle(std::size_t _index)
{
